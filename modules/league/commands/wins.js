module.exports = {
    ...
    async execute(message, args, extra) {
        ...
        const matchHistoryUrl = `https://${region}.api.riotgames.com/lol/match/v5/matches/by-puuid/${summoner.puuid}/ids?start=0&count=10&api_key=${apiKey}`;
        message.reply(matchHistoryUrl)
            ...
            if (error) {
                ...
                request(matchDetailsUrl, (error, response, body) => {
                    ...
                    this.logger.info("MATCH DETAILS: " + matchDetails)
